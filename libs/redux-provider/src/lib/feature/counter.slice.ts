...
//       })
//       .addCase(fetchCounter.fulfilled, (state: CounterState, action: PayloadAction<CounterEntity[]>) => {
...
// export const getCounterState = (rootState: RootState): CounterState => rootState[COUNTER_FEATURE_KEY];

// export const selectAllCounter = createSelector(getCounterState, selectAll);

// export const selectCounterEntities = createSelector(getCounterState, selectEntities);
